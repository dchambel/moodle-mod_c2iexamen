...
class questionInputRecord {
	...
	*/
	...
	/* full constructor */
	 public function questionInputRecord($id=0,$id_etab=0,$titre='',$referentielc2i='',$alinea=0,$id_famille_proposee=0,$positionnement='',$certification='',$etat='',$langue='',$auteur='',$auteur_mail='',$ts_datecreation=0,$ts_datemodification=0,$ts_dateutilisation=0){
		 $this->id=$id   ;
